...
for J in range(1):
    for I in range(2):
        ...
        FEPfile = "./Tests/test" + str(J+1) + "/fep" + str(I) + ".txt"
        Sqfile = "./Tests/test" + str(J+1) + "/Sq" + str(I) + ".txt"
        PSqfile = "./Tests/test" + str(J+1) + "/PSq" + str(I) + ".txt"
        FEPSqfile = "./Tests/test" + str(J+1) + "/fepSq" + str(I) + ".png"
        FEPPSqfile = "./Tests/test" + str(J+1) + "/fepPSq" + str(I) + ".png"
